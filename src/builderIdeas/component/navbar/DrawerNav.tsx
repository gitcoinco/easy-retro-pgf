  ...
  return (
    <Transition appear show={open} as={Fragment}>
      <Dialog
        open={open}
        as="div"
        className="relative z-40 flex lg:hidden"
        onClose={onClose}
      >
        ...
        <div className="fixed inset-0 h-full w-screen overflow-y-auto">
          <div className="flex h-full  items-center justify-center text-center ">
            <Transition.Child
              ...
              leaveTo=""
            >
              <Dialog.Panel className="h-full w-full transform overflow-hidden overflow-y-auto  bg-white text-left align-middle shadow-xl  transition-all">
                <Dialog.Title
                  as="div"
                  className="mr-4 flex h-[4.5em] items-center justify-between px-6"
                >
                  <Link
                  ...
                  <div
                    className="Hamburger flex cursor-pointer"
                    onClick={onClose}
                  >
                    <CloseIcon />
                  </div>
