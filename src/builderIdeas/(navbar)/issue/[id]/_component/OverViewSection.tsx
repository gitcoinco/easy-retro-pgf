...
export default function OverViewSection({
  ...
  return (
    <section
      ref={overViewRef}
      id="Overview"
      className="w-auto items-center border-0 bg-white p-5 sm:p-6 md:p-10 lg:mb-6 lg:rounded-md  lg:border"
    >
      <Link
        href="/#project"
      ...
      <hr className="my-6 hidden border-t  border-gray-300 lg:block" />
      ...
      <div className="my-4 flex  flex-col flex-wrap gap-2">
        ...
        <div className="mt-4 flex flex-row flex-wrap items-center gap-3">
          <Link
            className="w-fit rounded-3xl border bg-[#ff0420] px-8 py-3 text-white shadow-md transition duration-300 ease-linear hover:border-[#ff0420] hover:bg-white hover:text-[#ff0420]"
            href={
          ...
          <Link
            className="w-fit rounded-3xl border bg-black px-8 py-3 text-white shadow-md transition duration-300 ease-linear hover:invert"
