    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          className="z-50 w-[200px] rounded-xl border border-gray-300 bg-white p-2 dark:border-onSurfaceVariant-dark dark:bg-surfaceContainerLow-dark dark:text-white"
          sideOffset={5}
        >
